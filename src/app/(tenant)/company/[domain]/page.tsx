...
export default async function TenantLandingPage({
    ...
    const dashboardTitle = `${companyName} Learning Portal`;
    const landingPageText = `Welcome to the official learning portal for ${companyName}.`;
        ...
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 16px', zIndex: 10 }}>
                ...
                <div className="card glass-panel animate-fade-in-up animate-delay-300" style={{ padding: 'clamp(24px, 4vw, 40px)', width: '100%', maxWidth: '440px', textAlign: 'center' }}>
                    ...
                    <Link href="/login" className="btn-primary hover-scale" style={{ display: 'flex', width: '100%', background: `linear-gradient(135deg, ${themeColor}, ${themeColor}dd)`, padding: '14px', fontSize: '1rem', boxShadow: `0 8px 20px -8px ${themeColor}aa`, justifyContent: 'center', textDecoration: 'none' }}>
                        Go to Login Portal
                    </Link>
                </div>
            </div>
