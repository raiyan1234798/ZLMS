...
export const MOCK_COMPANIES: Company[] = [
    ...
    {
        id: 'c9',
        name: 'Z2Learn Academy',
        subdomain: 'z2learn',
        branding: {
            themeColor: '#10b981',
            dashboardTitle: 'Z2Learn Portal',
            landingPageText: 'Advanced learning for the next generation of creators.'
        },
        features: ['courses', 'video', 'analytics', 'certificates'],
        status: 'ACTIVE'
    },
    {
        id: 'c10',
        ...
        branding: {
            themeColor: '#ef4444',
            dashboardTitle: 'UST Training Center',
            landingPageText: 'Internal training and development for UST Global employees.'
        },
        features: ['courses', 'analytics', 'certificates', 'teams'],
        status: 'ACTIVE'
    }
];
